...
SPARK_HOME=$PROJECT_HOME/deps/spark-2.0.0-bin-hadoop2.4
...
curl -k -L -O http://d3kbcqa49mib13.cloudfront.net/spark-2.0.0-bin-hadoop2.4.tgz

mkdir -p $SPARK_HOME
tar zxf spark-2.0.0-bin-hadoop2.4.tgz --strip-components=1 -C $SPARK_HOME
rm -rf spark-2.0.0-bin-hadoop2.4.tgz
